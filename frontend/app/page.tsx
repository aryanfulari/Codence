      ...
      <section className="grid gap-10 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:py-24">
        <div className="fade-up space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h1 className="max-w-3xl text-5xl font-medium leading-[1.05] text-[var(--foreground)] lg:text-7xl">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={item}
                className="rounded-2xl border border-[var(--card-border)] bg-white/60 p-5"
              >
        ...
        <div className="fade-up-delay relative">
          <div className="overflow-hidden rounded-2xl border border-[var(--card-border)] bg-[var(--card)] shadow-[var(--shadow)]">
            <div className="flex items-center gap-2 border-b border-[var(--card-border)] bg-black/[0.02] px-5 py-3">
              ...
              <span className="ml-2 text-xs text-[var(--muted)]">metawiz.app/connect</span>
            </div>
